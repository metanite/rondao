            ...
            <div className="art">
    			...
    			<div className="art-body d-flex flex-column align-items-center justify-content-center">
    				<div className="art-body-row d-flex flex-column flex-md-row align-items-center justify-content-between col-11 col-md-10">
    					<div className="art-body-row-col col-md-6 col-lg-4 ml-md-auto order-2 order-md-1">
                    ...
                    <div className="art-body-row d-flex flex-column flex-md-row align-items-center justify-content-between col-11 col-md-10">
                        <div className="art-body-row-col col-12 col-lg-4 col-md-5 mr-lg-auto order-2">
	    					<h1 className="text-uppercase">
	    						Transparent Art
	    					</h1>
	    					<p className="text-justify">
                        ...
                        <div className="col-md-6 col-lg-6 offset-lg-1 order-1">
    						<img src={tronbullRainbow} alt="tronbull rainbow" className="img-fluid d-block mx-auto"></img>
    					</div>
    				</div>
                    <div className="art-body-row d-flex flex-column flex-md-row align-items-center justify-content-between col-11 col-md-10">
    					<div className="art-body-row-col col-lg-4 ml-lg-auto order-2 order-md-1">
	    					<h1 className="text-uppercase">
	    						Reliability Utility
	    					</h1>
	    					<p className="text-justify">
                ...
                <div className="art-market">
                    ...
                    <div className="d-flex flex-column flex-md-row align-items-center col-12">
                        <div className="col-12 col-md-5 offset-lg-2">
                            <img src={cryptoCoin} alt="cryto coin" className="img-fluid d-block mx-auto"></img>
                        </div>
                        <div className="art-market-xxl col-11 col-md-4 my-5 mt-md-0">
                            <h1>APENFT</h1>
